...
switch ($_GET['acao']) {
    ...
    case 'verificar_nome':
        ...
        if ($existe){
            echo "<div class='alert' style='background: #373737; color: #ffffff'><h3 class='text-center'>Já existe {$existe} classificacão chamada de {$_GET['nome']}, informe outra.</h3></div>";
        }
