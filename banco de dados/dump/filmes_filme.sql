...
CREATE TABLE `filme` (
  ...
  `critica` text COLLATE utf8_czech_ci NOT NULL,
  `trailer` text COLLATE utf8_czech_ci NOT NULL,
  `assistir` text COLLATE utf8_czech_ci NOT NULL,
  `indicacao` int(11) NOT NULL,
  `gasto` int(11) NOT NULL,
  `imagem` varchar(50) COLLATE utf8_czech_ci NOT NULL,
  `estudio` varchar(50) COLLATE utf8_czech_ci NOT NULL,
  `id_classificacao` int(11) NOT NULL,
  `id_pais` int(11) NOT NULL,
  `id_equipe` int(11) NOT NULL,
  `id_trabalho` int(11) NOT NULL,
  PRIMARY KEY (`id_filme`),
  KEY `fk_filme_equipe_has_trabalho1_idx` (`id_equipe`,`id_trabalho`),
  ...
  CONSTRAINT `fk_filme_equipe_has_trabalho1` FOREIGN KEY (`id_equipe`, `id_trabalho`) REFERENCES `equipe_trabalho` (`id_equipe`, `id_trabalho`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-10-27 23:56:44
